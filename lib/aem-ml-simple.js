    ...
    'text json': function (text) {
      ...
      if (json.gcGuid) {
        ...
        return Object.assign(json, {
          ...
          gcIssued: Date.parse(json.gcIssued || 0) / 1000,
          gcLastPublished: Date.parse(json.gcLastPublished || 0) / 1000,
          gcModifiedOverride: Date.parse(json.gcModifiedOverride || 0) / 1000,
        })
      }
