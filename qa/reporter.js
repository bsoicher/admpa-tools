...
(function (Mocha, $) {
  ...
  $.extend(this, Mocha.Runner.constants)

  //
  /*Object.keys(Mocha.Runner.constants).forEach(function(key) {
    this[key] = Mocha.Runner.constants[key]
  })*/
  ...
  var statsTemplate =
    '<ul id="mocha-stats">' +
    '<li class="progress"><div class="progress" style="height:50px;width:100%"><div class="progress-bar" role="progressbar" style="width: 0%"></div></div></li>' +
  ...
  function QA(runner, options) {
    ...
    $(document).on('click', 'a.passes', function (e) {
      $('.suite.hidden').removeClass('hidden')
